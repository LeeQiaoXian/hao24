...
! function(b) {
	b.matchMedia = b.matchMedia || function(h) {
		...
		return i.id = "mq-test-1", i.style.cssText = "position:absolute;top:-100em", j.style.background = "none", j.appendChild(i),
			function(c) {
				return i.innerHTML = '<style media="' + c + '"> #mq-test-1 { width: 42px; }</style>', l.insertBefore(j, k), g = 42 === i.offsetWidth, l.removeChild(j), {
					matches: g,
					media: c
				}
			}
		...
		var P, O, N, M = V.document,
			...
			C = function() {
				var h, g = M.createElement("div"),
					...
					i = !1;
				return g.style.cssText = "position:absolute;font-size:1em;width:1em", l || (l = i = M.createElement("body"), l.style.background = "none"), L.style.fontSize = "100%", l.style.fontSize = "100%", l.appendChild(g), i && L.insertBefore(l, L.firstChild), h = g.offsetWidth, i ? L.removeChild(l) : l.removeChild(g), L.style.fontSize = k, j && (l.style.fontSize = j), h = N = parseFloat(h)
			},
			B = function(Z) {
				var Y = "clientWidth",
					X = L[Y],
